...
if len(sys.argv) != 4:
    print("usage: python3 patch_ffma_src_regs.py src2_reg src3_reg output.cubin")
    print("example: python3 patch_ffma_src_regs.py 2 7 ffma_s2_2_s3_7.cubin")
    sys.exit(1)
...
infile = Path("ffma_reg_kernel.cubin")
sassfile = Path("ffma_reg_kernel.sass")
...
# For this observed sm_120 FFMA form:
#   FFMA R9, R0, R5, R7
# src2 is bits 32~39 in inst
# src3 is low 8 bits in ctrl
new_inst = old_inst
new_ctrl = old_ctrl
